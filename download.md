...
{% for item in site.data.releases.old %}{% assign ver=item | split: '.'%}{% assign vers=ver[0] |append: '.' |append: ver[1]%}* [v{{ item }}](https://github.com/plumed/plumed2/releases/tag/v{{ item }}) ([CHANGES](https://plumed.github.io/doc-v{{ vers }}/user-doc/html/{% if ver[1]<1 %}_c_h_a_n_g_e_s-2-0{% elseif ver[1]<4 %}_changelog{% else %}_change_log{% endif %}.html))
